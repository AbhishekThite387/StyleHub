  ...
  return productData ? (
    <div  className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex-1'>
        ...
        <button onClick={() => addToCart(productData._id,size)} className='bg-black hover:bg-gray-800 transition-colors rounded-sm text-white px-8 py-3 text-sm active:bg-gray-700'>ADD TO CART</button>
